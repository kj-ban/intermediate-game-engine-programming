...
namespace Gpm.CacheStorage
{
    ...
    public class CachePackage
    {
        ...
        public StringToValue<DateTime> lastRemoveTime;
        ...
        public CacheInfo RequestLocal(string url, RequestCallback onResult)
        {
        ...
        public CacheInfo Request(string url, CacheRequestType requestType, double reRequestTime, RequestCallback onResult)
        {
                ...
                if (requestResult.isSuccess == true)
                {
                    if (requestResult.responseCode == (long)HttpStatusCode.NotModified)
                    {
                        ...
                        if (cachedDatas != null)
                        {
                            ...
                            info.SendResult(cachedDatas, false);
                        }
                        else
                        {
