...
namespace Gpm.CacheStorage
{
    ...
    public class CacheInfo : IComparable<CacheInfo>
    {
        ...
        internal event RequestCallback callback;
        ...
        internal void SendResult(byte[] datas, bool updateData)
        {
            if (callback != null)
            {
                GpmCacheResult result = new GpmCacheResult(this, datas, updateData);
        ...
        public  void ReleaseCallback(RequestCallback releaseCallback)
        {
