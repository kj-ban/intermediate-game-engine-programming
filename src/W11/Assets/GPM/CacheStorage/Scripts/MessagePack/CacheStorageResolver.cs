...
namespace Gpm.CacheStorage.Resolvers
{
    using Formatters;
    ...
    internal static class CacheStorageGetFormatterHelper
    {
        ...
        static CacheStorageGetFormatterHelper()
        {
            lookup = new Dictionary<Type, int>(6)
            {
                ...
                {typeof(StringToValue<DateTime>), 5 },
            };
        }
        ...
        internal static object GetFormatter(Type t)
        {
            ...
            switch (key)
            {
                ...
                case 5:
                    {
                        return new StringToValueDateTimeFormatter();
                    }
                default:
                    {
                        return null;
...
namespace Gpm.CacheStorage.Formatters
{
    public sealed class CacheControlFormatter : IMessagePackFormatter<CacheControl>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, CacheControl value, IFormatterResolver formatterResolver)
        {
            ...
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<int>>().Serialize(ref bytes, offset, value.maxAge, formatterResolver);
        ...
        public CacheControl Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    case 0:
                        {
                            __maxAge__ = formatterResolver.GetFormatterWithVerify<StringToValue<int>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 1:
                        {
    ...
    public sealed class CacheInfoFormatter : IMessagePackFormatter<CacheInfo>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, CacheInfo value, IFormatterResolver formatterResolver)
        {
            ...
            offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.eTag, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Serialize(ref bytes, offset, value.lastModified, formatterResolver);
            offset += MessagePackBinary.WriteInt64(ref bytes, offset, value.lastAccess);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Serialize(ref bytes, offset, value.expires, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Serialize(ref bytes, offset, value.requestTime, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Serialize(ref bytes, offset, value.responseTime, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<int>>().Serialize(ref bytes, offset, value.age, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Serialize(ref bytes, offset, value.date, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<CacheControl>().Serialize(ref bytes, offset, value.cacheControl, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<int>>().Serialize(ref bytes, offset, value.contentLength, formatterResolver);
        ...
        public CacheInfo Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            ...
            var __lastModified__ = default(StringToValue<DateTime>);
            var __lastAccess__ = default(long);
            var __expires__ = default(StringToValue<DateTime>);
            var __requestTime__ = default(StringToValue<DateTime>);
            var __responseTime__ = default(StringToValue<DateTime>);
            var __age__ = default(StringToValue<int>);
            var __date__ = default(StringToValue<DateTime>);
            var __cacheControl__ = default(CacheControl);
            var __contentLength__ = default(StringToValue<int>);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case 1:
                        {
                            __eTag__ = formatterResolver.GetFormatterWithVerify<string>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 2:
                        {
                            __lastModified__ = formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 3:
                        {
                    ...
                    case 4:
                        {
                            __expires__ = formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 5:
                        {
                            __requestTime__ = formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 6:
                        {
                            __responseTime__ = formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 7:
                        {
                            __age__ = formatterResolver.GetFormatterWithVerify<StringToValue<int>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 8:
                        {
                            __date__ = formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 9:
                        {
                            __cacheControl__ = formatterResolver.GetFormatterWithVerify<CacheControl>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 10:
                        {
                            __contentLength__ = formatterResolver.GetFormatterWithVerify<StringToValue<int>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 11:
                        {
    ...
    public sealed class CachePackageFormatter : IMessagePackFormatter<CachePackage>
    {
        public int Serialize(ref byte[] bytes, int offset, CachePackage value, IFormatterResolver formatterResolver)
        {
            ...
            offset += formatterResolver.GetFormatterWithVerify<List<CacheInfo>>().Serialize(ref bytes, offset, value.cacheStorage, formatterResolver);
            ...
            offset += formatterResolver.GetFormatterWithVerify<List<CacheInfo>>().Serialize(ref bytes, offset, value.removeCache, formatterResolver);
            offset += formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Serialize(ref bytes, offset, value.lastRemoveTime, formatterResolver);
            return offset - startOffset;
        }

        public CachePackage Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset) == true)
            {
                readSize = 1;
            ...
            var __lastRemoveTime__ = default(StringToValue<DateTime>);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    case 0:
                        {
                            __cacheStorage__ = formatterResolver.GetFormatterWithVerify<List<CacheInfo>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 1:
                        {
                    ...
                    case 4:
                        {
                            __removeCache__ = formatterResolver.GetFormatterWithVerify<List<CacheInfo>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    case 5:
                        {
                            __lastRemoveTime__ = formatterResolver.GetFormatterWithVerify<StringToValue<DateTime>>().Deserialize(bytes, offset, formatterResolver, out readSize);
                            break;
                        }
                    default:
                        {
